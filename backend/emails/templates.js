      ...
      <body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f4f7f6; padding: 20px; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 40px; border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.05);">
          ...
          <div style="margin-top: 25px; margin-bottom: 25px; text-align: center;">
            ...
            <img src="https://kleine-musikschule.de/images/alex-portrait-square.jpg" alt="Alexander Flöter" width="100" height="100" style="width: 100px; height: 100px; border-radius: 50%; border: 3px solid #9bf1ff; display: inline-block;">
          </div>
