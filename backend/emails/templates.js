          ...
          <table border="0" cellpadding="0" cellspacing="0" style="margin-top: 25px; margin-bottom: 25px;">
            <tr>
              <td style="padding-right: 20px; vertical-align: middle;">
                <p style="font-size: 16px; line-height: 1.5; margin: 0; color: #333;">Ganz herzliche musikalische Grüße,</p>
                <p style="font-size: 16px; line-height: 1.5; margin: 4px 0 0 0; color: #2c3e50;"><strong>Alexander Flöter</strong><br><span style="color: #666; font-size: 14px;">Kleine Musikschule Karlsruhe</span></p>
              </td>
              <td style="vertical-align: middle;">
                <img src="https://kleine-musikschule.de/images/alex-portrait-square.jpg" alt="Alexander Flöter" width="100" height="100" style="width: 100px; height: 100px; border-radius: 50%; border: 3px solid #9bf1ff; display: block;">
              </td>
            </tr>
          </table>
